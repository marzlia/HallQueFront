...
public:
	...
	void SetAllCtrlHide();
	void SetAllCtrlShow();
	void SetAllCtrlLinkPageIDNULL(UINT nPageID);
private:
...
public:
	...
	void SetSerialID(UINT nSerialID){m_nSerialID = nSerialID;}//设置界面ID
	UINT GetSerialID(){return m_nSerialID;}
	void SetBackPath(const CString& path){m_strBackImagePath = path;}//设置界面背景
	CString GetBackPath()const {return m_strBackImagePath;}
};
