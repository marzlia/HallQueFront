...
BOOL CWndContentDlg::OnInitDialog()
{
	...
	m_listctr_wndscreen.InsertColumn(nCol++,_T("窗口屏"),LVCFMT_CENTER,rect.Width()*15/100,-1);
	m_listctr_wndscreen.InsertColumn(nCol++,_T("综合屏"),LVCFMT_CENTER,rect.Width()*15/100,-1);
	m_listctr_wndscreen.InsertColumn(nCol++,_T("通屏IP"),LVCFMT_CENTER,rect.Width()*30/100,-1);
	m_listctr_wndscreen.InsertColumn(nCol++,_T("通屏物理地址"),LVCFMT_CENTER,rect.Width()*15/100,-1);
	m_listctr_wndscreen.InsertColumn(nCol++,_T("通屏通道"),LVCFMT_CENTER,rect.Width()*15/100,-1);
